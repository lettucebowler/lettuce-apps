...
function P(e) {
  return {
    ...
    abortEarly:
      ...
      (a == null ? void 0 : a.abortEarly),
    abortPipeEarly:
      (e == null ? void 0 : e.abortPipeEarly) ??
      (a == null ? void 0 : a.abortPipeEarly),
  };
}
var v;
// @__NO_SIDE_EFFECTS__
...
function b(e, t, n, u, s) {
  const c = s && "input" in s ? s.input : n.value,
    i = (s == null ? void 0 : s.expected) ?? e.expects ?? null,
    r = (s == null ? void 0 : s.received) ?? /* @__PURE__ */ m(c),
    l = {
      kind: e.kind,
      type: e.type,
      input: c,
    ...
    y =
      ...
      e.message ??
      /* @__PURE__ */ _(e.reference, l.lang) ??
      (p ? /* @__PURE__ */ x(l.lang) : null) ??
      u.message ??
      /* @__PURE__ */ S(l.lang);
  y &&
    (l.message =
    ...
    "~run"(n, u) {
      ...
      if (s && typeof s == "object") {
        ...
        for (const i in this.entries) {
          ...
          if (
            i in s ||
            ((r.type === "exact_optional" ||
              r.type === "optional" ||
              r.type === "nullish") && // @ts-expect-error
              r.default !== void 0)
          ) {
            const l =
                i in s
            ...
            if (p.issues) {
              ...
              for (const f of p.issues)
                f.path ? f.path.unshift(y) : (f.path = [y]),
                  (c = n.issues) == null || c.push(f);
          ...
          } else if (r.fallback !== void 0) n.value[i] = /* @__PURE__ */ M(r);
          else if (
            r.type !== "exact_optional" &&
            r.type !== "optional" &&
            r.type !== "nullish" &&
...
function j(e, t) {
  return {
    ...
    "~run"(n, u) {
      return (
        this.options.includes(n.value) ? (n.typed = !0) : b(this, "type", n, u),
        n
      );
    },
  };
...
function g(e) {
  return {
    ...
    "~run"(t, n) {
      return (
        typeof t.value == "string" ? (t.typed = !0) : b(this, "type", t, n), t
      );
    },
  };
}
